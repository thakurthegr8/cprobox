          ...
          <Layout.Col className="gap-2">
            <Layout.Row>
              ...
              <Layout.Row className="h-full w-full">
                <Link href={`/profile/${data._id}/followers`}><Button>Followers {data.followers.length}</Button></Link>
                <Link href={`/profile/${data._id}/following`}><Button>Following {data.following.length}</Button></Link>
              </Layout.Row>
            </Layout.Row>
            <Layout.Row>
